  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.secSabores}>
        <Image src={Sabores} alt="Sorvetes variados" className={styles.img}/>
      ...
      <section className={styles.secEventos}>
        <div className={styles.containerTexto}>
        ...
        <Image src={Eventos} alt="Mesa com sorvetes" className={styles.img}/>
      </section>

      <section className={styles.secSobre}>
        <Image src={Sobre} alt="Pessoas felizes" className={styles.img}/>
        <div className={styles.containerTexto}>
          <h2>SOBRE NÓS</h2>
